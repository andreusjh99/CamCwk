...
unitcell = ase.lattice.cubic.Diamond(directions=[[1,1,1], [1,1,-2], [1,-1,0]],
...
del atoms[[atom.index for atom in atoms if abs(atom.position[0]-cx) < 1.0 and abs(atom.position[1]-cy) > neck ]]
